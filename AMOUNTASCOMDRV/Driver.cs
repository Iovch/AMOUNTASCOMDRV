...
//
// ASCOM Telescope driver for AMOUNT
//
...
{
    //
    // Your driver's DeviceID is ASCOM.AMOUNT.Telescope
    //
    // The Guid attribute sets the CLSID for ASCOM.AMOUNT.Telescope
    // The ClassInterface/None addribute prevents an empty interface called
    // _AMOUNT from being created and used as the [default] interface
    //
    ...
    /// ASCOM Telescope Driver for AMOUNT.
    /// </summary>
    [Guid("5b53854c-51e1-4a74-8f95-0723f882c493")]
    ...
    public class Telescope : ITelescopeV3
    {
        ...
        /// </summary>
        private static string driverDescription = "ASCOM Telescope Driver for AMOUNT.";
